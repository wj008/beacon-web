...
<div class="message">
    ...
    {if !empty($info.dialog) && $info.dialog=='close'}
        <p style="padding-top: 10px; text-align: center;">页面自动 <a style="color: #333" id="back" href="javascript:closeDialog();">关闭</a> 等待时间： <b id="wait">1</b></p>
    ...
    {elseif !empty($info.back)}
        <p style="padding-top: 10px;padding-left: 30px">页面自动 <a style="color: #333" id="back" href="{$info.back}">跳转</a> 等待时间： <b id="wait">1</b></p>
    {literal}
        <script type="text/javascript">
