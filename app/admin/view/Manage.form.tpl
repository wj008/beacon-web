...
{block name='form-header'}
    <a class="yee-back" href="{url act='index' ctl='Manage'}"><i class="icofont-reply"></i></a>
    ...
    <form method="post" yee-module="validate ajax">
        <div class="yee-panel">
            <div class="panel-caption">
                ...
                <h3>{if $form->isAdd()}新增账号信息{else}编辑账号信息{/if}</h3>
            </div>
                ...
                {foreach from=$form->getViewFields() item=field}
                    <div class="yee-row" id="row_{$field->boxId}">
                        ...
                        <div class="row-cell">
                            ...
                            <p class="yee-field-tips">{$field->tips}</p>
                        </div>
                    </div>
                {/foreach}
            </div>
            <div class="yee-submit">
                ...
                <div class="submit-cell">
                    ...
                    <input type="hidden" name="__BACK__" value="{url act='index' ctl='Manage'}">
                    <a href="{url act='index' ctl='Manage'}" class="form-btn back">返回</a>
                </div>
            </div>
