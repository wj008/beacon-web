        ...
        <div class="yee-panel">
                ...
                {foreach from=$form->getViewFields() item=field}
                    <div class="yee-row" id="row_{$field->boxId}">
                        ...
                        <div class="row-cell">
                            ...
                            {if $field->prompt}<p class="yee-field-prompt">{$field->prompt}</p>{/if}
                        </div>
                    </div>
                {/foreach}
            </div>
            <div class="yee-submit">
                ...
                <div class="submit-cell">
                    ...
                    <input type="hidden" name="__BACK__" value="{url act='index' ctl='Manager'}">
                    <a href="{url act='index' ctl='Manager'}" class="form-btn back">返回</a>
                </div>
            </div>
        </div>
    </form>
