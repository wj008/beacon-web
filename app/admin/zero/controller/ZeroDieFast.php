...
use app\admin\zero\form\ZeroDieFastSearch;

class ZeroDieFast extends ZeroController
{
    ...
    protected function zeroLoad(){ 
        return [
            'actionForm' => 'app\\admin\\zero\\form\\ZeroDieFastForm',
            'tbName' => '@pf_die_fast',
            'pageSize' => 20,
            'template' => 'ZeroDieFast.tpl',
            'templateHook' => 'ZeroDieFast.hook.tpl'
        ];
    }
    ...
    protected function zeroSelector(){ 
        $selector = new SqlSelector('@pf_die_fast');
        $param = $this->param();
